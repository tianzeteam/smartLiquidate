...
func PushMainnetTokens(_counter counter.Counter, liquidateAndLoanContract *liquidatecontract.Liquidatecontract, client *ethclient.Client, priKey string, _gasPrice string, _gasLimit int) {
